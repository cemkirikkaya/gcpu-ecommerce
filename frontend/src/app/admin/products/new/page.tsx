    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="mt-8 max-w-3xl space-y-6">
        <input
          name="name"
          required
          placeholder="Ürün adı (örn. iPhone 17 — renk/hafıza varyantlarda)"
          className="w-full rounded-full border border-line bg-background px-5 py-3 text-sm outline-none focus:border-accent"
        />
        <p className="text-sm text-muted">
          Aynı isimle ürün eklediğinizde yeni kayıt oluşturulmaz; renk ve hafıza gibi
          seçenekler mevcut ürüne otomatik eklenir.
        </p>
        <textarea
          name="description"
