...
class OrderReturnApprovedMail extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: "{$label} talebiniz onaylandı — #{$this->returnRequest->order_id}",
        );
    }
    ...
    public function content(): Content
    {
        ...
        return new Content(
            markdown: 'mail.orders.return-approved',
            with: [
